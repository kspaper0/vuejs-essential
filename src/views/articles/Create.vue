        ...
        <div class="panel-body">
          ...
          <div data-validator-form>
            <div class="form-group">
              <input v-model.trim="title" v-validator:blur.required="{ title: 'Title' }" type="text" class="form-control" placeholder="Please leave a title" @input="saveTitle">
            </div>
            <div class="form-group">
<!--               <textarea v-validator.required="{ title: '内容' }" class="form-control" placeholder="请使用 Markdown 格式书写 ;-)，代码片段黏贴时请注意使用高亮语法。"></textarea> -->
            ...
            <br>
            <div class="form-group">
              <button class="btn btn-primary" type="submit" @click="post">Publish</button>
            </div>
          </div>
        </div>
      </div>

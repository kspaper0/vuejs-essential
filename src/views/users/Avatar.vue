  ...
  <div class="col-md-9 left-col">
    <div class="panel panel-default padding-md">
        <div class="panel-body">
            <h2><i class="fa fa-picture-o"></i> Please input the full address of an avatar </h2>
        <hr>
        <div data-validator-form>
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-lg btn-primary" @click="updateAvatar">Upload</button>
          </div>
        </div>
        </div>
    </div>
    ...
    updateAvatar() {
      ...
      if (avatar) {
        ...
        img.onload = () => {
          ...
          this.$message.show('Uploaded Successfully')
        }

        img.onerror = () => {
          this.$message.show('Failed', 'danger')
        }
